  ...
  return (
    <div className="section-shell py-16">
      <div className="paper-panel rounded-[2rem] border border-[var(--border-light)] p-8 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-[var(--text-body)]">Try browsing the marketplace again or jump back to the homepage.</p>
        <div className="mt-6 flex justify-center gap-3">
          ...
          <Link href="/" className="focus-ring rounded-full border border-[var(--border-medium)] px-5 py-3 text-sm font-semibold text-[var(--ink)] transition hover:bg-white/70">
            Back home
          </Link>
        </div>
      </div>
