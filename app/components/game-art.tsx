  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col justify-between">
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.24em] text-white/85">PnP cover preview</p>
          <h3 className="mt-2 max-w-[18rem] text-2xl font-semibold leading-tight">{title}</h3>
          <p className="mt-3 max-w-[20rem] text-sm leading-6 text-white/88">{subtitle}</p>
        </div>
      </div>
    </div>
  );
