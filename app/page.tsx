  ...
  return (
    <div className="pb-20">
      <section className="section-shell grid gap-8 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:py-18">
        <div className="paper-panel paper-texture rounded-[2.4rem] border border-[rgba(77,57,36,0.08)] px-7 py-8 sm:px-10 sm:py-10">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-[rgba(58,43,31,0.76)]">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link href="/optimizer" className="focus-ring rounded-full border border-[rgba(77,57,36,0.14)] px-5 py-3 text-sm font-semibold text-[var(--ink)] transition hover:bg-white/70">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={label} className="rounded-[1.5rem] bg-white/70 p-4">
                ...
                <p className="mt-2 text-sm text-[rgba(58,43,31,0.74)]">{label}</p>
              </div>
            ))}
          </div>
        </div>
              ...
              {[
                ...
                <div key={title} className="flex gap-4 rounded-[1.5rem] bg-white/70 p-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-[rgba(58,43,31,0.74)]">{body}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="section-shell mt-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <Link href="/marketplace" className="focus-ring rounded-full border border-[rgba(77,57,36,0.12)] px-5 py-3 text-sm font-semibold text-[var(--ink)] transition hover:bg-white/70">
            See all games
          </Link>
        </div>
      ...
      <section className="section-shell mt-20 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="paper-panel rounded-[2rem] border border-[rgba(77,57,36,0.08)] p-7">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-[1.5rem] bg-[rgba(216,165,65,0.12)] p-4">
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--ink)]">This month’s focus</p>
              <p className="mt-3 text-sm leading-6 text-[rgba(58,43,31,0.78)]">Bright card fronts, low-ink backs, and a friendly cardstock-friendly assembly guide.</p>
            </div>
            <div className="rounded-[1.5rem] bg-[rgba(54,90,76,0.1)] p-4">
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--ink)]">Perfect for</p>
              <p className="mt-3 text-sm leading-6 text-[rgba(58,43,31,0.78)]">Weekend makers who want a tidy build with plenty of table charm and room to personalize.</p>
            </div>
          </div>
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            {craftAlong ? (
              <Link href={`/games/${craftAlong.slug}`} className="focus-ring rounded-full border border-[rgba(77,57,36,0.12)] px-5 py-3 text-sm font-semibold text-[var(--ink)] transition hover:bg-white/70">
                View featured game
              </Link>
            ) : null}
          </div>
      ...
      <section className="section-shell mt-20">
        <div className="paper-panel rounded-[2.2rem] border border-[rgba(77,57,36,0.08)] px-7 py-8 sm:px-10">
          <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-[rgba(58,43,31,0.76)]">
            ...
            <div className="flex flex-wrap gap-3 lg:justify-end">
              ...
              <MockActionButton
                ...
                className="focus-ring rounded-full border border-[rgba(77,57,36,0.12)] px-5 py-3 text-sm font-semibold text-[var(--ink)] transition hover:bg-white/70"
              />
            </div>
          </div>
        </div>
